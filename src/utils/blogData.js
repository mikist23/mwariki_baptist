export const blogPosts = [
  {
    id: 1,
    slug: 'why-faith-generation-is-key',
    title: 'Why Faith Generation is Key',
    date: 'June 04, 2025',
    author: 'Pastor John Doe',
    summary: 'Understanding the roots of our belief systems helps us grow stronger together.',
    content: `
    ...
    likes: 24,
    comments: [
      { user: 'Grace W.', text: 'This is so inspiring! Thank you for sharing.', date: 'June 05, 2025' },
      { user: 'Sam K.', text: 'Exactly what I needed to hear today.', date: 'June 06, 2025' }
    ]
  },
  {
    id: 2,
    slug: 'the-importance-of-service',
    title: 'The Importance of Service',
    date: 'May 12, 2025',
    author: 'Sister Mary Anne',
    summary: 'True leadership and fulfillment are found in serving others with a humble heart.',
    content: `
    ...
    likes: 18,
    comments: [
      { user: 'Peter O.', text: 'Service truly brings joy.', date: 'May 13, 2025' }
    ]
  },
  {
    id: 3,
    slug: 'studying-the-bible-effectively',
    title: 'Studying the Bible Effectively',
    date: 'April 28, 2025',
    author: 'Elder James',
    summary: 'Discover practical ways to deepen your understanding and application of the Word.',
    content: `
      <p>The Bible is our roadmap for life, but many find it daunting to study. Effective Bible study isn't just about reading words on a page; it's about engaging with the Holy Spirit to uncover the truths that transform us.</p>
